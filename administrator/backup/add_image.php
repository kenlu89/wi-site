...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0" class="images">
 ...
 <form name="form1" action="add_image_pro1.php"  enctype="multipart/form-data" method="post">
...
<?php }else{?>
<a href="Font.php?id=<?php echo $row_pull['ids']; ?>&parent=<?php echo $_GET['id']; ?>" target="_self" class="text"><img src="images/thumbnail.jpg" height="120" width="100" /></a>
			<?php }?>			</td>
