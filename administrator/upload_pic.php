...
$good=@mysql_query("update products set products_image1='$test' where products_id='$ids'");
if($good){
echo "<script>alert('Picture has been uploaded.');window.location='Front.php?id=$ids';</script>";
}else{
echo "<script>alert('Picture has been uploaded failure.');window.location='Front.php?id=$ids';</script>";
}
