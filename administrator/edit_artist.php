...
if($_GET['id']!=""){
$result=mysql_query("select * from artist where ids=".$_GET['id']);
...
if($files=="" || $files==NULL){
@mysql_query("update artist set artist='$artist', description='$description', last_edit='$times' where ids='$id'");
...
@mysql_query("update artist set artist='$artist', description='$description', last_edit='$times', image='$test' where ids='$id'");
echo "<script>alert('artist has been added.');window.location='artist.php';</script>";
}else{
...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0" class="text">
  ...
  <tr>
    <td height="81" colspan="4" valign="top" class="left"><?php include("top.php"); ?></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td colspan="2" valign="middle"><input type="text"  name="artist" size="55" class="text"  value="<?php echo $row['artist'];?>"/></td>
  </tr>
  <tr>
    <td height="163">&nbsp;</td>
    <td valign="top">Artist Description</td>
    <td colspan="2" valign="top"><textarea name="description" rows="10" cols="65" class="text" ><?php echo $row['description'];?></textarea></td>
  </tr>
  <tr>
    <td height="21">&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <td valign="top"><img src="../<?php echo $row['image'];?>" /></td>
  </tr>
  ...
  <tr>
    <td height="35" colspan="4" align="center" valign="middle" class="text"> <?php include("bottom.php"); ?></td>
  </tr></form>
</table>
