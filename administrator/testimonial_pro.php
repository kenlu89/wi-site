...
$good=@mysql_query("insert into testimonial (pic, txt, txt1) values ('$test', '$txt', '$txt1')");
if($good){
echo "<script>alert('Picture has been uploaded.');window.location='testimonial.php?id=$ids';</script>";
}else{
echo "<script>alert('Picture has been uploaded failure.');window.location='testimonial.php?id=$ids';</script>";
}
