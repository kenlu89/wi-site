...
@mysql_query("insert into color (parent_id, color) values('$current', '$color')"); 

echo "<script>alert('Products Info has been updated！');window.location='Color.php?id=$current';</script>";	
}
...
document.location.href='Color.php?id='+ids;
...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0" class="images">
 ...
 <form name="form1" action="Color.php"  enctype="multipart/form-data" method="post">
 <input  type="hidden" name="current" value="<?php echo $ids; ?>" />
  ...
  <tr>
    <td height="25">&nbsp;</td>
    <td valign="top"><span class="Heading">Existing Color:</span></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    </tr>
  <tr>
	  ...
	  ?>
	    <tr>
	      <td width="100" height="24">&nbsp;</td>
            <td width="191" valign="middle" class="text"><?php echo $row_pull['color']; ?></td>
          <td width="134" valign="middle" class="text">
		    <a href="color_remove.php?id=<?php echo $row_pull['ids']; ?>&parent_id=<?php echo $row_pull['parent_id']; ?>" target="_self" class="left_nav">Remove</a></td>
	      <td width="373">&nbsp;</td>
	    </tr>
  <?php }?>
        </table></td>
