...
@mysql_query("insert into style (parent_id, style) values('$current', '$color')"); 

echo "<script>alert('Products Info has been updated!');window.location='style.php?id=$current';</script>";	
}
...
document.location.href='style.php?id='+ids;
...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0" class="images">
 ...
 <form name="form1" action="style.php"  enctype="multipart/form-data" method="post">
 <input  type="hidden" name="current" value="<?php echo $ids; ?>" />
  ...
  <tr>
    <td height="30"></td>
    <td valign="middle" class="Heading">Size:</td>
  ...
  <tr>
    <td height="25">&nbsp;</td>
    <td valign="top"><span class="Heading">Existing Size:</span></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    </tr>
  <tr>
    <td height="24" colspan="4" valign="top">
	  <table width="100%" border="0" cellpadding="0" cellspacing="0">
	    <!--DWLayoutTable-->
	    <?php $pull_pid=@mysql_query("select * from style where parent_id='$ids' order by ids asc");
	  ...
	  ?>
	    <tr>
	      <td width="100" height="24">&nbsp;</td>
            <td width="191" valign="middle" class="text"><?php echo $row_pull['style']; ?></td>
          <td width="134" valign="middle" class="text">
		    <a href="style_remove.php?id=<?php echo $row_pull['ids']; ?>&parent_id=<?php echo $row_pull['parent_id']; ?>" target="_self" class="left_nav">Remove</a></td>
	      <td width="373">&nbsp;</td>
	    </tr>
  <?php }?>
        </table></td>
