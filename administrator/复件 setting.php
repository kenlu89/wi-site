...
//$stats="ok";
 ...
 $ids=$row['ids'];
 $done=@mysql_query("update config set  kitchen_printer='$kitchen_printer', counter_printer='$counter_printer', waiter_printer='$waiter_printer', stats='$keys', discount='$discount' where ids='$ids'");
 }else{
$done=@mysql_query("insert into config(kitchen_printer,  counter_printer, waiter_printer, discount, stats) values('$kitchen_printer', '$counter_printer', '$waiter_printer', '$discount', '$keys')"); 
 }
...
<table width="798" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td colspan="2" valign="middle"><input type="text" size="15" class="text"  name="discount" value="<?php echo $rows['discount'];?>"></td>
    <td colspan="2" valign="middle"><?php echo ENABLE_KEYPAD;?><input type="radio" name="keys" value="1" class="text" /><?php echo ENABLE; ?> &nbsp; &nbsp; &nbsp; <input type="radio" name="keys" value="0" class="text" /> <?php echo DISABLE; ?><td>
    </tr>
   ...
   <tr>
     ...
     <td colspan="2" valign="middle" class="text"><!--DWLayoutEmptyCell-->&nbsp;</td>
     <td width="259" valign="middle"  class="text"><!--DWLayoutEmptyCell-->&nbsp;</td>
   </tr>
   <tr>
    <td height="25">&nbsp;</td>
    <td colspan="2" valign="middle" class="text"><strong><?php echo KARGO_PRINTER;?></strong></td>
  <td colspan="2" valign="middle" class="text"><strong><?php echo PRODUCT_PRINTER;?></strong></td>
  <td valign="middle"  class="text"><strong><?php echo SHIPPING_PRINTER;?></strong></td>
  </tr>
  <tr>
    <td height="39">&nbsp;</td>
