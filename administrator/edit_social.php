<?php 
$id=$_GET['id'];
$media=@mysql_query("select * from social_meida where social_meida_id='$id' order by social_meida_id desc");
$rows=mysql_fetch_array($media);
 $title=$rows['meida_name'];
 $link=$rows['meida_url'];
$sort_order=$rows['sort_order'];
$language=$rows['language_id'];
...
$done=@mysql_query("update social_meida set meida_name='$title', meida_url='$link', language_id='$language', sort_order='$sort_order' where social_meida_id='$id'");
...
@mysql_query("update social_meida set meida_image='$test' where social_meida_id='$id'");
}
}
...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0" class="text">
 ...
 <input  type="hidden" name="chk" value="1" />
  ...
  <tr>
    ...
    <td colspan="4" valign="middle"><input type="text" name="title" class="text" size="70"  value="<?php echo $title;?>"/></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td height="24">&nbsp;</td>
  ...
  <tr>
    ...
    <td colspan="4" valign="middle"><input type="text" name="link" class="text" size="70" value="<?php echo $link;?>"/></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td height="24">&nbsp;</td>
