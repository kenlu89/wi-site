...
@mysql_query("update products set products_id=1 where products_id='$ori'");
@mysql_query("update products_description set products_id=1 where products_id='$ori'");
@mysql_query("update products set products_id='$ori' where products_id='$swap'");
@mysql_query("update products_description set products_id='$ori' where products_id='$swap'");
@mysql_query("update products set products_id='$swap' where products_id=1");
...
$r1=@mysql_query("select * from products_to_categories, products_description, products where products_to_categories.categories_id='$cate' and  products_description.products_id=products_to_categories.products_id and products_description.products_id=products.products_id order by products.products_id desc");
}else{
