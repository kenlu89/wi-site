...
@mysql_query("insert into size (parent_id, size) values('$current', '$color')"); 

echo "<script>alert('Products Info has been updated！');window.location='size.php?id=$current';</script>";	
}
...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0" class="images">
 ...
 <form name="form1" action="size.php"  enctype="multipart/form-data" method="post">
  ...
  <tr>
    <td height="24" colspan="4" valign="top">
	  <table width="100%" border="0" cellpadding="0" cellspacing="0">
	    <!--DWLayoutTable-->
	    <?php $pull_pid=@mysql_query("select * from size where parent_id='$ids' order by ids asc");
	  ...
	  ?>
	    <tr>
	      <td width="100" height="24">&nbsp;</td>
            <td width="191" valign="middle" class="text"><?php echo $row_pull['size']; ?></td>
          <td width="134" valign="middle" class="text">
		    <a href="size_remove.php?id=<?php echo $row_pull['ids']; ?>&parent_id=<?php echo $row_pull['parent_id']; ?>" target="_self" class="left_nav">Remove</a></td>
	      <td width="373">&nbsp;</td>
	    </tr>
  <?php }?>
        </table></td>
