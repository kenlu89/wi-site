<select name="states" class="text">
                                  ...
                                  <option value="CDA"<?php if($state=="CDA"){ echo "selected";}?>>Canada</option>
                                  ...
                                  <option value="MN"<?php if($state=="MN"){ echo "selected";}?>>Minnesota</option>                                  <option value="MS"<?php if($state=="MS"){ echo "selected";}?>>Mississippi</option>
                                  ...
                                  <option value="UT"<?php if($state=="UI"){ echo "selected";}?>>Utah</option>
                                  <option value="VT"<?php if($state=="VI"){ echo "selected";}?>>Vermont</option>
