...
if($files!=""){
unlink("../images/bg_top_line1.jpg");
...
$extension = $extension[extension];
 $test1=$uploaddir.'/'."bg_top_line1.$extension";
$test='images'.'/'."bg_top_line1.$extension";
rename($_FILES['file']['tmp_name'], $uploaddir.'/'."bg_top_line1.$extension");	
...
header("Location: ?content=main_bg&msg=1");
}
...
<table width="800" border="0" cellpadding="0" cellspacing="0" class="text" >
            <!--DWLayoutTable-->
            <form action="?content=main_bg" enctype="multipart/form-data"  method="post">
