...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0" class="images">
 ...
 <input  type="hidden" name="chk" value="1" />
  ...
  <tr>
    ...
    <td colspan="2" valign="middle" class="text">Add/Edit products to categories</td>
    <td>&nbsp;</td>
  </tr>
  ...
  <tr>
    ...
    <td colspan="3" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="text">
      ...
      <tr>
        ...
        <input type="checkbox" class="text" name="pid[]"<?php if($rows['best']==1){ echo  "checked='checked'"; } ?>  value="<?php echo $rows['products_id']; ?>" /><?php echo $rows['products_model']; $rows=mysql_fetch_array($r1);?></td>
