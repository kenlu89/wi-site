...
(function(a){
    a.fn.number_slideshow=function(p){
        ...
        var button_current_text_color=p&&p.slideshow_button_current_text_color?p.slideshow_button_current_text_color:"#ccc";
        ...
        function play(){
            if(n=="enable"){
                ...
                F.find(".number_slideshow_nav").children("li").eq(E).css("background-color","#d04c61");
        ...
        function s_s_ul(a,b,c,d,e,f,g,h,i,l_g){
            ...
            var j=d+"px";
            var k=c+"px";
            var l="border: #ccc solid "+" "+e+"px; height:"+j+"; width:"+k+"; padding:"+b+"px; background-color:"+g+"; background-image:url("+l_g+");";
            a.attr("style",l)
        }
        function s_s_n(b,c,d,e,f,g,h){
            ...
            var a=j.children("a");
            a.css("color",c);
            var k="border: #ccc  solid "+" "+h+"px; background-color:#FF66FF;";
            j.attr("style",k);
            if(d!="enable"){
                b.hide()
            }
